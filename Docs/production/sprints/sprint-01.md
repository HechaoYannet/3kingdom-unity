...
| DOC-02 | Reverse-document Asset Bundle Framework | design / programming | 1.5 | DOC-01 | `Docs/gdd/asset-bundle-framework.md` exists with 8 required sections |
| DOC-03 | Reverse-document Data Management and Event System | design / programming | 1.5 | DOC-01 | `Docs/gdd/data-management.md` and `Docs/gdd/event-system.md` exist with 8 required sections |
...
- [ ] QA plan exists (`Docs/production/qa/qa-plan-sprint-01.md`)

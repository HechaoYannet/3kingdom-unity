...
Make the existing Unity/Tuanjie project safe for repeatable design, architecture, sprint, and testing workflows.

## Exit Criteria

- [ ] `Docs/gdd/systems-index.md` is present and kept in sync with current GDDs
